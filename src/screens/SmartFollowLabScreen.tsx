...
import { wordProgressTarget, applyBackwardDeadband } from '../smartfollow/positionMap'
...
export function SmartFollowLabScreen() {
  ...
  // Continuous per-word target: eases with reading progress *across* the matched word's visual line
  // rather than snapping a whole line at each wrap — so the text flows instead of stepping. The
  // engine's velocity-limited follow adds the final smoothing on top.
